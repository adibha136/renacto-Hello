                    ...
                    <div class="wrapper-content pd-all-20">
                        ...
                        @if (is_plugin_active('captcha'))
                            ...
                            <div class="form-group">
                                <input type="hidden" name="enable_math_captcha_in_register_page" value="0">
                                <label>
                                    <input type="checkbox"  value="1" @checked(get_ecommerce_setting('enable_math_captcha_in_register_page', 0)) name="enable_math_captcha_in_register_page">
                                    {{ trans('plugins/ecommerce::ecommerce.setting.enable_math_captcha_in_register_page') }}
                                </label>
                            </div>
                        @endif
