...
@endif
<div class="header-top header-top-ptb-1 d-none d-lg-block overflow-hidden">
    <div class="container">
                    ...
                    <div class="header-action-right">
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <a href="{{ route('customer.overview') }}" class="header-customer-name"><span class="lable ml-0">{{ auth('customer')->check() ? Str::limit(auth('customer')->user()->name, 10) : __('Account') }}</span></a>
