            ...
            <div class="flexbox-annotated-section-content">
                <div class="wrapper-content pd-all-20" id="email-config-form">
                    <div class="form-group mb-3">
                        ...
                        {!! Form::customSelect('email_driver', [
                            'smtp' => 'SMTP',
                            'mailgun' => 'Mailgun',
                            'ses' => 'SES',
                            'postmark' => 'Postmark',
                            'log' => 'Log',
                            'array' => 'Array',
                        ] + (function_exists('proc_open') ? ['sendmail' => 'Sendmail'] : []), setting('email_driver', config('mail.default')), ['class' => 'setting-select-options']) !!}
                    </div>
                    ...
                    <div data-type="sendmail" class="setting-wrapper @if (setting('email_driver', config('mail.default')) !== 'sendmail') hidden @endif">
                        <div class="form-group mb-3">
                            ...
                            {!! Form::helper(trans('core/setting::setting.email.default') . ': <code>' . config('mail.mailers.sendmail.path') . '</code>') !!}
                        </div>
                    </div>
